...
jQuery(function() {
  $.miniTip = function(element, options) {
    ...
    getArrowCss = function() {
      ...
      _arrow_left_offset = _this.getSetting('arrow_left_offset');
      ...
      switch (position) {
        ...
        case "bottom":
          ...
          _arrowCss = {
            'top': '-11px',
            'left': _left + _arrow_left_offset +'px',
    ...
    this.getPosition = function() {
      ...
      _left_offset = _this.getSetting('left_offset');
      coordinates = this.$element.offset();
      switch (position) {
        case "bottom":
          coordinates['left'] = coordinates.left - 3 -_left_offset;
        ...
        case "right":
          ...
          break;
        default:
           coordinates['left'] = coordinates.left + 10;
